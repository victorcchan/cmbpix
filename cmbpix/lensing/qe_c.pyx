        ...
        for l1y from -lmax <= l1y < lmax by dl:
            ...
            for l2x from -lmax <= l2x < lmax by dl:
                ...
                for l2y from -lmax <= l2y < lmax by dl:
                    ...
                    l1dotl2minusl1 = l1x*(l2x-l1x)+l1y*(l2y-l1y)
...
@cython.wraparound(False)
@cython.cdivision(True)
def N1_bias_integral_cy_Hanson(int LL, double[:] ClTTunlensed, double[:] ClTTtotal, double[:] Clphiphi, int lmin, int lmax, int dl):
        ...
        for l1y from -lmax <= l1y < lmax by dl:
            ...
            for l2x from -lmax <= l2x < lmax by dl:
                ...
                for l2y from -lmax <= l2y < lmax by dl:
                    ...
                    l1dotl1minusl2 = l1x*(l1x-l2x)+l1y*(l1y-l2y)
                    Lminusl1dotl1minusl2 = (L-l1x)*(l1x-l2x) + (-l1y)*(l1y-l2y)
                    l1dotl1minusLplusl2 = (l1x-L+l2x)*l1x + (l1y+l2y)*l1y
                    l2dotl1minusLplusl2 = (l1x-L+l2x)*l2x + (l1y+l2y)*l2y
                    ...
                    if (modl1 < lmin or modl1 > lmax):
                        ...
                        integral += 1. \
                            ...
                            * 1./(2. * ClTTtotal[modl2] * ClTTtotal[modLminusl2]) \
                            * ( Clphiphi[modl1minusl2] \
                            * l1dotl1minusl2 * Lminusl1dotl1minusl2 * ClTTunlensed[modl1] * ClTTunlensed[modLminusl1] \
                            # * ( -l1dotl2minusl1*ClTTunlensed[modl1] + l2dotl2minusl1*ClTTunlensed[modl2] ) \
                            # * ( -Lminusl1dotl1minusl2*ClTTunlensed[modLminusl1] + Lminusl2dotl1minusl2*ClTTunlensed[modLminusl2] ) \
                            - Clphiphi[modl1minusLplusl2] \
                            * l1dotl1minusLplusl2 * l2dotl1minusLplusl2 * ClTTunlensed[modl1] * ClTTunlensed[modl2] )
                            # * ( -Lminusl1minusl2dotl1*ClTTunlensed[modl1] + Lminusl1minusl2dotLminusl2*ClTTunlensed[modLminusl2] ) \
                            # * ( -l1minusLplusl2dotLminusl1*ClTTunlensed[modLminusl1] + l1minusLplusl2dotl2*ClTTunlensed[modl2] ) )
    
    integral *= -4*dl*dl*dl*dl
...
@cython.wraparound(False)
@cython.cdivision(True)
def N1_bias_integral_cy_Kesden2(int LL, double[:] ClTTunlensed, double[:] ClTTtotal, double[:] Clphiphi, int lmin, int lmax, int dl):
                ...
                for l2y from -lmax <= l2y < lmax by dl:
                    ...
                    if (modl1 < lmin or modl1 > lmax):
                        ...
                        integral += 1. \
                            ...
                            * 1./(2. * ClTTtotal[modl2] * ClTTtotal[modLminusl2]) \
                            * ( Clphiphi[modl1minusl2] \
                                * ( -Ldotl1*ClTTunlensed[modl1] + Ldotl2*ClTTunlensed[modl2] ) \
                                * ( -LdotLminusl1*ClTTunlensed[modLminusl1] + LdotLminusl2*ClTTunlensed[modLminusl2] ) \
                            # * ( -l1dotl2minusl1*ClTTunlensed[modl1] + l2dotl2minusl1*ClTTunlensed[modl2] ) \
                            # * ( -Lminusl1dotl1minusl2*ClTTunlensed[modLminusl1] + Lminusl2dotl1minusl2*ClTTunlensed[modLminusl2] ) \
                            + Clphiphi[modl1minusLplusl2] \
                            # * ( -Lminusl1minusl2dotl1*ClTTunlensed[modl1] + Lminusl1minusl2dotLminusl2*ClTTunlensed[modLminusl2] ) \
                            # * ( -l1minusLplusl2dotLminusl1*ClTTunlensed[modLminusl1] + l1minusLplusl2dotl2*ClTTunlensed[modl2] ) )
                                * ( -Ldotl1*ClTTunlensed[modl1] + LdotLminusl2*ClTTunlensed[modLminusl2] ) \
                                * ( -LdotLminusl1*ClTTunlensed[modLminusl1] + Ldotl2*ClTTunlensed[modl2] ) )
